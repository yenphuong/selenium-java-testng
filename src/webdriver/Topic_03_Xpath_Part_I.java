...
public void Register_01_Empty_Data() {
	...
	// Truy cập vào trang: https://alada.vn/tai-khoan/dang-ky.html
	...
	driver.findElement(By.xpath("//button[@type='submit']")).click();// Click vào button đăng kí
...
public void Register_06_Invalid_Phone_Number() {
		...
		// Verify (actual data = expected data) < 10 ki tu
		...
		driver.findElement(By.id("txtPhone")).sendKeys("098765432144");
		driver.findElement(By.xpath("//button[@type='submit']")).click();// Click vào button đăng kí
		Assert.assertEquals(driver.findElement(By.id("txtPhone-error")).getText(), "Số điện thoại phải từ 10-11 số.");
		
		//  start without phone number
		driver.findElement(By.id("txtPhone")).clear();
		driver.findElement(By.id("txtPhone")).sendKeys("44444");
		driver.findElement(By.xpath("//button[@type='submit']")).click();// Click vào button đăng kí
